const extendedLinkedInProjects = [
  ...
  { id: '6898596949595963392', title: '세계 X 실시간 언급량 분석', summary: '전 세계 X 게시물의 실시간 언급 데이터를 ELK 기반으로 수집하고 지역·키워드별 흐름을 시각화했습니다.', tags: ['Social Data', 'ELK', 'Realtime Analytics'], images: 1 },
  ...
  { id: '6942824331953475584', title: '비트코인·삼성전자 상승 패턴 AI', summary: '비트코인과 삼성전자 시계열에서 상승 구간의 공통 특성을 추출하고 AI 기반 패턴 탐지 결과를 비교했습니다.', tags: ['Pattern Detection', 'Bitcoin', 'Samsung'], images: 2 },
  ...
  { id: '6945965873748680704', title: '삼성전자 주가 패턴 모델', summary: '삼성전자 가격 데이터의 반복 패턴을 모델링하고 상승·하락 구간의 특징과 예측 신호를 분석했습니다.', tags: ['Samsung Electronics', 'Pattern Model', 'Finance AI'], images: 1 },
  ...
  { id: '6966376048817045504', title: '비트코인 하강 패턴 탐지', summary: '비트코인 가격의 하강 구간을 자동 탐지하고 과거 유사 패턴과 이후 움직임을 비교 분석했습니다.', tags: ['Bitcoin', 'Downtrend', 'Pattern Detection'], images: 3 },
  { id: '6959121388012015616', title: 'Bitcoin Prediction', summary: '비트코인 시계열 데이터를 기반으로 향후 가격 흐름을 예측하고 실제 움직임과 모델 결과를 비교했습니다.', tags: ['Bitcoin', 'Prediction', 'AI'], images: 1 },
  ...
  { id: '6946013333846126592', title: '6개 종목 상승 패턴 분석', summary: '6개 종목의 상승 신호를 모델로 추출하고 각 시계열의 패턴 강도와 발생 시점을 시각적으로 비교했습니다.', tags: ['Stocks', 'Uptrend', 'Comparative Analysis'], images: 6 },
  { id: '6969158325892509696', title: '비트코인 추가 하락 분석', summary: '하락 신호 이후 비트코인의 추가 조정 가능성을 과거 패턴과 지표를 통해 점검한 후속 분석입니다.', tags: ['Bitcoin', 'Risk Analysis', 'Downtrend'], images: 3 },
  { id: '6942488061721088000', title: '비트코인 가격 AI 예측', summary: '가격·추세 데이터를 학습한 AI 모델로 비트코인의 다음 움직임을 예측하고 결과를 차트로 표현했습니다.', tags: ['Bitcoin', 'AI Forecast', 'Price'], images: 1 },
  { id: '6970402530157625344', title: '비트코인 추가 하락·반등 예측', summary: '비트코인의 추가 하락 위험과 반등 가능 시나리오를 패턴 기반 예측 모델로 동시에 분석했습니다.', tags: ['Bitcoin', 'Scenario Analysis', 'Forecast'], images: 1 },
  { id: '6963433430944559104', title: '비트코인 급상승 분석', summary: '비트코인 급상승 구간의 선행 패턴과 가격 변화를 추출해 상승 신호의 특징을 분석했습니다.', tags: ['Bitcoin', 'Surge', 'Data Analysis'], images: 1 },
  ...
  { id: '6962395940192227329', title: '비트코인 상승 분석', summary: '비트코인 상승 구간을 탐지하고 거래 데이터와 기술적 패턴을 활용해 상승 흐름을 해석했습니다.', tags: ['Bitcoin', 'Uptrend', 'Analytics'], images: 1 },
  { id: '6961174006230134784', title: '비트코인 중장기 추세', summary: '단기 노이즈를 줄인 시계열 분석으로 비트코인의 중장기 추세와 방향 전환 가능성을 살펴봤습니다.', tags: ['Bitcoin', 'Long-term Trend', 'Time Series'], images: 1 },
